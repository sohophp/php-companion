...
const artifacts = [
  ...
  {
    path: 'packages/php-companion-extension-pack/php-companion-open-source-pack-0.4.1.vsix',
    required: [
      'extension/package.json',
      'extension/readme.md',
  ...
  {
    path: 'packages/php-companion-recommended-pack/php-companion-recommended-pack-0.4.1.vsix',
    required: [
      'extension/package.json',
      'extension/readme.md',
      'extension/package.nls.zh-cn.json',
