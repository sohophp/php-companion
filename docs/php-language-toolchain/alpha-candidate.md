...
Windows 客户端连接 WSL Remote 时，应在 Remote 窗口确认 PHP Companion 和工作区扩展运行于 WSL Extension Host，并让 PHP CLI、Composer 根、formatter 与 PHPUnit 路径都解析到 WSL 项目。Windows 本地安装成功不能代替这项检查。
