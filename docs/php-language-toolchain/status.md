...
R4/F13 的 Linux x64 连续编辑、取消、重启与损坏缓存恢复证据见 [长时间编辑与恢复门禁](reports/editing-resilience-linux-x64-2026-09-13.md)；当前候选的 Linux、Windows 与 macOS CI 证据见 [跨平台候选验收报告](reports/cross-platform-candidate-2026-09-14.md)。
